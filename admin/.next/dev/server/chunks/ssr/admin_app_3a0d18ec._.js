...
"[project]/admin/app/dashboard/vouchers/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function VouchersPage() {
    const [vouchers, setVouchers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [confirmVoucher, setConfirmVoucher] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const fetchVouchers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        setLoading(true);
        try {
            const params = {
                page
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminApi"].getVouchers(params);
    ...
    const confirmValidate = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminApi"].manualValidateVoucher(confirmVoucher.id);
            fetchVouchers();
        } catch (err) {
    ...
    const columns = [
        {
            ...
            render: (value)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    fileName: "[project]/admin/app/dashboard/vouchers/page.tsx",
                    lineNumber: 71,
                    columnNumber: 9
                }, this)
        },
        {
            key: "profile",
            label: "Usuario",
            render: (_, row)=>row.profile?.full_name || row.user_name || "—"
        },
        {
            key: "restaurant",
            label: "Restaurante",
            render: (_, row)=>row.restaurant?.name || row.restaurant_name || "—"
        },
        {
            key: "status",
            label: "Status",
        ...
        },
        {
            ...
            label: "Acoes",
            render: (_, row)=>{
                const isAvailable = row.status === "available" || row.status === "Disponivel";
                if (!isAvailable) {
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
//# sourceMappingURL=admin_app_3a0d18ec._.js.map