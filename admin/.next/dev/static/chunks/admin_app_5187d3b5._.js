...
"[project]/admin/app/dashboard/vouchers/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function VouchersPage() {
    _s();
    const [vouchers, setVouchers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [confirmVoucher, setConfirmVoucher] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const fetchVouchers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VouchersPage.useCallback[fetchVouchers]": async ()=>{
            setLoading(true);
            try {
                const params = {
                    page
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminApi"].getVouchers(params);
    ...
    }["VouchersPage.useCallback[fetchVouchers]"], [
        page,
        search,
        statusFilter
    ]);
    ...
    const confirmValidate = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminApi"].manualValidateVoucher(confirmVoucher.id);
            fetchVouchers();
        } catch (err) {
    ...
    const columns = [
        {
            key: "code",
            label: "Codigo",
            render: (value)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(VouchersPage, "xGiKuLuJNKem28MpUa8oA0hFmh0=");
_c = VouchersPage;
var _c;
...
//# sourceMappingURL=admin_app_5187d3b5._.js.map