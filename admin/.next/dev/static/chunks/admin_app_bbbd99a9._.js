...
function UsersPage() {
    ...
    const [confirmUser, setConfirmUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const fetchUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UsersPage.useCallback[fetchUsers]": async ()=>{
            ...
            try {
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminApi"].getUsers(params);
                setUsers(res.data);
    ...
    const confirmToggleSuspend = async ()=>{
        ...
        try {
            if (confirmUser.suspended_at) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminApi"].activateUser(confirmUser.id);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminApi"].suspendUser(confirmUser.id);
            }
            fetchUsers();
        } catch (err) {
...
_s(UsersPage, "45WyPtySw2yU5n5Wdu8ppBKvjns=", false, function() {
    return [
...
//# sourceMappingURL=admin_app_bbbd99a9._.js.map